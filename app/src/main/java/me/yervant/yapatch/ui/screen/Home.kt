            ...
            Column(modifier = Modifier.padding(PaddingValues(all = 24.dp))) {
                ...
                Row(
                    ...
                    TextButton(onClick = {
                        ...
                        APApplication.uninstallYAPatch()
                    }) {
                ...
                Column(
                    ...
                    when (apState) {
                        ...
                        APApplication.State.ANDROIDPATCH_NEED_UPDATE -> {
                            ...
                            Text(
                                text = stringResource(
                                    R.string.yapatch_version_update,
    ...
    ElevatedCard {
        Column(
            ...
            if (apState != APApplication.State.UNKNOWN_STATE && apState != APApplication.State.ANDROIDPATCH_NOT_INSTALLED) {
                InfoCardItem(
                    stringResource(R.string.home_yapatch_version), managerVersion.second.toString()
                )
                Spacer(Modifier.height(16.dp))
            }
