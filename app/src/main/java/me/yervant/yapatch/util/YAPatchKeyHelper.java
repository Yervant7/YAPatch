...
public class YAPatchKeyHelper {
    ...
    private static final String KEY_ALIAS = "YAPatchSecurityKey";
    ...
    public static void writeSPSuperKey(String key) {
        ...
        key = YAPatchKeyHelper.encrypt(key);
